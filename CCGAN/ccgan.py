...
class CCGAN():
    ...
    def build_discriminator(self):
        ...
        # model.add(Conv2D(64, kernel_size=3, strides=1, padding='valid', input_shape=self.img_shape, activation='relu'))
        # model.add(Conv2D(64, kernel_size=3, strides=1, padding='valid', activation='relu'))
        # model.add(MaxPooling2D(pool_size=(2, 2), strides=2))
        #
        # model.add(Conv2D(128, kernel_size=3, strides=1, padding='valid', activation='relu'))
        # model.add(Conv2D(128, kernel_size=3, strides=1, padding='valid', activation='relu'))
        # model.add((MaxPooling2D(pool_size=(2, 2), strides=2)))
        #
        ...
        #
        # model.add(Conv2D(512, kernel_size=3, strides=1, padding='valid', activation='relu'))
        # model.add(Conv2D(512, kernel_size=3, strides=1, padding='valid', activation='relu'))
        # model.add(Conv2D(512, kernel_size=3, strides=1, padding='valid', activation='relu'))
        # model.add(Conv2D(512, kernel_size=3, strides=1, padding='valid', activation='relu'))
        # model.add(MaxPooling2D(pool_size=2, strides=2))
