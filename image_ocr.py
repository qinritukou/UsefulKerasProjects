...
def paint_text(text, w, h, rotate=False, ud=False, multi_fonts=False):
    ...
    with cairo.Context(surface) as context:
        ...
        # teach the RNN translational invarianvce by 
...
# Translation of characters to unique intetger values 
...
class TextImageGenerator(keras.callbacks.Callback):
    ...
    def get_batch(self, index, size, train):
        # width and height area backwards from typical Keras convention 
        ...
        for i in range(size):
            ...
            # achiving translational invariance 
...
class VizCallback(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):
        self.model.save_weights(os.path.join(self.output_dir, 'weights_%02d.h5' % (epoch)))
...
def train(run_name, start_epoch, stop_epoch, img_w):
    ...
    # Two layers of bidrectional GRUs 
    # GRU seems to work as wel, if not better than LSTM 
